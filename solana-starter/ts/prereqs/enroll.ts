...
const github = Buffer.from("tidvn", "utf8");
...
(async () => {
  try {
    ...
    //https://explorer.solana.com/tx/47TPvVjTN7hzXdc5NQhHyn6Z5hLpiSozkwnrV8VpxWM4HrPYhxYy5e2FKzEzg83HdQdTsQe12af7DBkVwiwnAmML?cluster=devnet
  } catch (e) {
